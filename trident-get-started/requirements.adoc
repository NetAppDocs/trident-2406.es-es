...
[%collapsible%open]
====
* Kubernetes 1.30 ahora es compatible con Astra Trident. Actualice Astra Trident antes de actualizar Kubernetes.
...
Astra Trident y ONTAP se pueden utilizar como proveedor de almacenamiento delink:https://kubevirt.io/["Virt de KubeVirt"].


WARNING: Antes de actualizar un clúster de Kubernetes de 1,24 a 1,25 o una versión posterior que tenga Astra Trident instalado, consulte link:../trident-managing-k8s/upgrade-operator.html#upgrade-a-helm-installation["Actualizar una instalación Helm"]el .
