...
Ahora puedes crear `TridentOrchestrator` e instalar Astra Trident. Opcionalmente, puede link:kubernetes-customize-deploy.html["Personalice su instalación de Trident"] utilizar los atributos de la `TridentOrchestrator` especificación.
