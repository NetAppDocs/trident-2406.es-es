...
Astra Trident es compatible con la expansión de volumen para VP NFS aprovisionados en `ontap-nas`, , `ontap-nas-economy` `ontap-nas-flexgroup` `gcp-cvs` y `azure-netapp-files` back-ends.
