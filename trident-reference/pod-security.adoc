...
| PID del host | Necesario para iniciar `rpc-statd` para NFS. Astra Trident consulta a los procesos del host para determinar `rpc-statd` si se están ejecutando antes de montar los volúmenes de NFS. 
