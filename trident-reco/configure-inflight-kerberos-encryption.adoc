...
.Antes de empezar
* Asegúrese de link:../trident-use/enable-acp.html["Habilitado Astra Control Provisioning"^] tener en el clúster gestionado.
...
.Antes de empezar
* Asegúrese de haber habilitado el aprovisionador de Astra Control en el clúster Red Hat OpenShift gestionado. Consulte link:../use/enable-acp.html["Habilita el aprovisionador de Astra Control"^] para obtener instrucciones.
* Asegúrese de tener acceso a la `tridentctl` utilidad.
